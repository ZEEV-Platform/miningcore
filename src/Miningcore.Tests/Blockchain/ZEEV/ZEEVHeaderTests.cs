...
namespace Miningcore.Tests.Blockchain.ZEEV
{
    public class ZEEVHeaderTests : TestBase
    {
        ...
        public void HeaderSerializationTest()
        {
            ...
            var headerBlock = new ZEEVBlockHeader(headerHex2);
            ...
            var h208877 = new ZEEVBlockHeader(header208877);

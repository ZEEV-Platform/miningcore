...
public enum ZEEVTransactionCategory
{
    /// <summary>
...
public class ZEEVConstants
{
    public const int ExtranoncePlaceHolderLength = 8;
    public const decimal SatoshisPerZEEV = 100000000;
...
public enum ZEEVRPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in ZEEVd
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9, //!< ZEEV is not connected
...
public static class ZEEVCommands
{

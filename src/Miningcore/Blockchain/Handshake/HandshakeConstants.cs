...
public enum HandshakeAddressType
{
    /// <summary>
    /// Legacy address
    /// </summary>
...
public enum HandshakeTransactionCategory
{
    /// <summary>
...
public class HandshakeConstants
{
    ...
    public const decimal SatoshisPerHandshake = 100000000;
...
public enum HandshakeRPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in Handshaked
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9, //!< Handshake is not connected
...
public static class HandshakeCommands
{
